...
import com.s3543757.alexanderknapik.animalsatrisk.R;

/**
 * Created by user on 24/04/18.
 */

public class SearchAreasListActivity extends ListActivity implements View.OnClickListener {
    static class SimpleAdapter extends ArrayAdapter<Item> implements PinnedSectionListView.PinnedSectionListAdapter {

      private static final int[] COLORS = new int[]
          {
              R.color.green_section,
              R.color.orange_section,
              R.color.blue_section,
              R.color.red_section
          };
      ...
      private static final int[] HIGHLIGHT_COLORS = new int[]
        ...
        @Override public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (item.type == Item.ITEM) {
                view.setBackgroundColor((HIGHLIGHT_COLORS[(item.sectionPosition % HIGHLIGHT_COLORS.length)]));
            }
            */
