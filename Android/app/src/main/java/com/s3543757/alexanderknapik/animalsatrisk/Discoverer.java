...
Discoverer.java was code provided by Dr. PJ Radcliffe
Copyright (C) 2018 under no license
However, permission to use this code was granted under no restrictions.

Changes I have made to the program was to remove functionality of the broadcasting, to just be used
by calling the thread and listening for a reply.
In another class, I will be using this reply and storing it into a database.
...
class Discoverer extends Thread {
    ...
    private static final int DISCOVERY_PORT = 50010;//UDP socket port
    private static final int TIMEOUT_MS = 100000;   //Timeout in ms
    ...
    private UDPTester callingActivity;
...
//====== Constructor ========================================================
    ...
    Discoverer(/*String SSID, String PW,*/ Context activityContext, Activity A) {
        ...
        broadcastData = "Hello world!\0";
        deviceData = "Did not even receive own broadcast, wifi down?";
        callingActivity = (UDPTester) A; // This is a pointer to the main activity.
...
//====== Run ================================================================
    ...
    public void run() { //--- executes when thread started.
            ...
            try {
                //Start the thread and grab the socket.
